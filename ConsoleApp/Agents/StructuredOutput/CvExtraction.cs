...
internal static class CvExtraction
{
    ...
    public static async Task RunAsync()
    {
        ...
        {
            throw new FileNotFoundException($"CV file was not found at '{cvPath}'.", cvPath);
        }
        ...
        var agent = StructuredOutputSetup.CreateStructuredAgent<CvInfo>(
            chatClient,
            agentName: "CvExtractor",
            instructions: "Extract only information explicitly present in the supplied CV. " +
            ...
            schemaDescription: "CV information containing name, email, phone, skills, experience, and education");
